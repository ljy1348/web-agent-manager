...
function request(origin: string | undefined, host: string, encrypted = false): IncomingMessage {
  return { headers: { origin, host }, socket: { encrypted } } as unknown as IncomingMessage;
}
